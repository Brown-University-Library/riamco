Rails.application.routes.draw do
  ...
  get 'renderfile/:eadid/:filename' => 'ead#view_file', as: :ead_view_file,
  ...
  get 'upload/check_exists_published' => 'upload#check_exists_published', as: :upload_check_exists_published

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:ead="urn:isbn:1-931666-22-9" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ns2="http://www.w3.org/1999/xlink">
    ...
    <xsl:preserve-space elements="ead:controlaccess"/>
...
<div class="nav_column">
                            ...
                            <div class="right_two_thirds">
                                <h1>
                                    <a href="render_pending.php?eadid={$eadid}&amp;view=title">
...
<xsl:template match="ead:dsc/ead:dao[@ns2:href]">
    <a href="http://dl.lib.brown.edu/repository2/repoman.php?verb=render&amp;id={@ns2:href}">
        <xsl:apply-templates select="ead:dsc/ead:did/ead:unittitle"/>
    </a>
</xsl:template>
...
<xsl:template match="ead:dao[@xlink:href]">
        <a href="http://library.brown.edu/cds/repository2/repoman.php?verb=render&amp;id={@xlink:href}">
